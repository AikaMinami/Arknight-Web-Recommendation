...
<div class = "users table">
    ...
    <div class="main"> 
        <button> 
            <a class= "button" href="calculation/calculation.php" style="font-weight:bold">Proceed to calculation</a>
        </button>
    </div>

    <div class="main">     
        <button>
            <a href="index.php" class="button" style="font-weight:bold">Back To Home</a>
        </button>
    </div>
</div>
